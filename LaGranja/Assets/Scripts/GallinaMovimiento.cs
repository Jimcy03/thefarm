...
public class GallinaMovimiento : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector2 direccion = posicionActual - (Vector2)destino;
        ...
        {
            sr.flipX = false; //ir a la derecha | estado natural
        }
    ...
    void NuevoDestino() {
        ...
        float y = Random.Range(centro.y - tamaño.x / 2f, centro.x + tamaño.y / 2f);
